...
/* harmony import */ var _modules_showMoreCard__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/showMoreCard */ "./src/js/modules/showMoreCard.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_showMoreCard__WEBPACK_IMPORTED_MODULE_5__["default"])('.button-styles', '#styles .row');
...
var burger = function burger(menuSelector, burgerSelector) {
  ...
  }); // Если экран становится не планшетным, то скрываем меню
...
var drop = function drop() {
  ...
  fileInputs.forEach(function (input) {
    input.addEventListener('drop', function (e) {
      ...
      var name = arr[0].substring(0, 15) + dots + arr[1];
...
/* harmony import */ var _services_requiests__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../services/requiests */ "./src/js/services/requiests.js");
...
var forms = function forms() {
  ...
  form.forEach(function (item) {
    item.addEventListener("submit", function (e) {
      ...
      }, 400); // Добавление картинки при отправке формы

      var statusImg = document.createElement("img");
      statusImg.setAttribute("src", message.spinner);
      statusImg.classList.add("animated", "fadeInUp");
      statusMessage.appendChild(statusImg); //ДОбавление текста
      ...
      var api; // Выбираем путь до сервера для отпраки данных

      item.closest(".popup-design") || item.classList.contains('calc-form') ? api = path.designer : api = path.question;
      Object(_services_requiests__WEBPACK_IMPORTED_MODULE_6__["postData"])(api, formData).then(function (res) {
        console.log(res);
...
var modal = function modal() {
  ...
  function showModalByTime(selector, time) {
    setTimeout(function () {
      var display; // не открывает другие модальные окна, если уже что-то открыто
  ...
  function removeScroll() {
    ...
    div.remove();
    return scrollWidth;
  } // Открывается когда пользователь доходит до конца страницы
...
/***/ "./src/js/modules/showMoreCard.js":
/*!****************************************!*\
  !*** ./src/js/modules/showMoreCard.js ***!
  \****************************************/
/*! exports provided: default */
...
/* harmony import */ var core_js_modules_web_dom_collections_for_each__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! core-js/modules/web.dom-collections.for-each */ "./node_modules/core-js/modules/web.dom-collections.for-each.js");
/* harmony import */ var core_js_modules_web_dom_collections_for_each__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_web_dom_collections_for_each__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _services_requiests__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../services/requiests */ "./src/js/services/requiests.js");





var showMoreCard = function showMoreCard(trigger, wrapper) {
  var button = document.querySelector(trigger);
  button.addEventListener("click", function () {
    Object(_services_requiests__WEBPACK_IMPORTED_MODULE_3__["getResource"])('assets/db.json').then(function (res) {
...
/* harmony default export */ __webpack_exports__["default"] = (showMoreCard);
...
var sliders = function sliders(slides, dir, prev, next) {
  ...
  } catch (_unused) {} // Убриает автоматичемкую прокрутку слайдера, если пользоваетль навел курсор на него


  var activeteAnimation = function activeteAnimation() {
    if (dir === 'vertical') {
